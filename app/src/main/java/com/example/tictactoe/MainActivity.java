...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkwin(int[][] c,int f){
        ...
        if((c[0][0]==1 && c[1][1]==1 && c[2][2]==1) || (c[0][2]==1 && c[1][1]==1 && c[2][0]==1) || (c[0][0]==1 && c[0][1]==1 && c[0][2]==1) || (c[1][0]==1 && c[1][1]==1 && c[1][2]==1) || (c[2][0]==1 && c[2][1]==1 && c[2][2]==1) || (c[0][0]==1 && c[0][1]==1 && c[0][2]==1) || (c[0][1]==1 && c[1][1]==1 && c[2][1]==1) || (c[0][2]==1 && c[1][2]==1 && c[2][2]==1))
        {
            showwin(f);
        }
        else{
    ...
    {
        ImageButton zero0=findViewById(R.id.zerozero);
        ImageButton zero1=findViewById(R.id.zeroone);
        ImageButton zero2=findViewById(R.id.zerotwo);
        ImageButton one0=findViewById(R.id.onezero);
        ImageButton one1=findViewById(R.id.oneone);
        ImageButton one2=findViewById(R.id.onetwo);
        ImageButton two0=findViewById(R.id.twozero);
        ImageButton two1=findViewById(R.id.twoone);
        ImageButton two2=findViewById(R.id.twotwo);
